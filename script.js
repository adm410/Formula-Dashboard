  ...
  fetch(`https://ergast.com/api/f1/${year}/driverstandings.json`)
    ...
    .then(data => {
      ...
      drivers.forEach(driver => {
        ...
        const nationality = driver.Constructors[0].nationality;
...
function updateCalendarTable(year) {
  ...
  calendarTable.innerHTML = "<tr><td colspan='3' class='loading-cell' colspan='3'><span class='spinner-border spinner-border' role='status' aria-hidden='true'></span>Loading...</td></tr>";
